...
class FlickrDataset(Dataset):
    def __init__(self, root_dir, caption_file, transform=None, freq_threshold=0.5):
...
# dataloader = get_loader("/media/anwar/25ff85f1-4207-4d23-90c3-9ec96feba2cb/Flickr8K/Flickr8k_Images/",
#                         annotation_file="captions.txt", transform=transform)
#
